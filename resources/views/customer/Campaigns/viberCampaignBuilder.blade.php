                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.viber.campaign_builder') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <select class="select2 form-select" id="contact_groups" name="contact_groups[]" multiple="multiple">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" id="schedule" class="form-check-input schedule" value="true" name="schedule" {{ old('schedule') ? "checked" : null }}>
