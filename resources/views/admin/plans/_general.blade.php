                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $plan->name }}" name="name" required autocomplete="name">
                                @error('name')
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                <div class="form-check me-3 me-lg-5 mt-1">
                                    <input type="checkbox" class="form-check-input" id="is_dlt" value="true" name="is_dlt" {{ $plan->is_dlt == true ? 'checked': null }}>
                                    <label class="form-label" for="is_dlt">{{__('locale.labels.dlt')}}</label>
                                </div>
                                <p><small class="text-muted">{{__('locale.labels.trai_dlt')}}</small></p>
