                                ...
                                <form class="form form-vertical" action="{{ route('admin.plans.store') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" id="billing_cycle" name="billing_cycle">
                                                    ...
                                                    <option value="monthly" selected }}>  {{__('locale.labels.monthly')}}</option>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                <div class="form-check me-3 me-lg-5 mt-1">
                                                    <input type="checkbox" class="form-check-input" id="is_dlt" value="true" name="is_dlt">
                                                    <label class="form-label" for="dlt">{{__('locale.labels.dlt')}}</label>
                                                </div>
