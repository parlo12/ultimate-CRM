                            ...
                            <form class="form form-vertical"
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                <label class="form-label required">{{__('locale.labels.sending_server')}}</label>
                                                <select class="form-select select2" id="sending_server_id" name="sending_server_id">
                                                    @foreach($sending_servers as $sending_server)
                                                    <option {{ isset($number->sending_server_id) && $number->sending_server_id == $sending_server->id ? 'selected' : null }} value="{{$sending_server->id}}"> {{ $sending_server->name }}
